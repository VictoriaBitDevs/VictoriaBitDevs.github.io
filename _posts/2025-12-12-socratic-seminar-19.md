...
meetup: https://www.meetup.com/victoriabitcoin/events/312214995/
---
## Announcements
Please join us for our 19th socratic seminar in the city of Victoria. Please make sure you are RSVP'd, an identifier (but not a full name) is required for entry.
...
- [Benchmarking Bitcoin Script Evaluation for the Varops Budget (Great Script Restoration)](https://delvingbitcoin.org/t/benchmarking-bitcoin-script-evaluation-for-the-varops-budget-great-script-restoration/2094)

### Meetings

#### Bitcoin Core general developer meetings
- [November 27](https://www.erisian.com.au/bitcoin-core-dev/log-2025-11-27.html)
- [December 04](https://www.erisian.com.au/bitcoin-core-dev/log-2025-12-04.html)

#### Lightning Specification Meetings
- [2025/11/17](https://github.com/lightning/bolts/issues/1296)
...
## Network Data
- [A thread on Cluster mempool](https://x.com/murchandamus/status/1854678133896626293)
...
- [On Scalability Power of Payment Channel Networks](https://sites.ualberta.ca/~mkhabbaz/assets/pdf/Compression.pdf)
- [Outfox: a Packet Format for a Layered Mixnet](https://arxiv.org/abs/2412.19937)
- [How to factor 2048 bit RSA integers with less than a million noisy qubits](https://arxiv.org/abs/2505.15917)
- [Making SLH-DSA 10x-100x Faster](https://conduition.io/code/fast-slh-dsa/)
- [Payment-failure times for random Lightning paths](https://arxiv.org/abs/2511.16376)
- [Time Tells All: Deanonymization of Blockchain RPC Users with Zero Transaction Fee](https://dl.acm.org/doi/abs/10.1145/3719027.3765082)
- [Towards Post-Quantum Bitcoin Blockchain using Dilithium Signature](https://cic.iacr.org/p/2/3/3)
...
## InfoSec
- <a href="https://brink.dev/blog/2025/11/19/bitcoin-core-security-audit/" style="color: blue;">An Independent Security Audit of Bitcoin Core</a>
- [Account Takeover Fraud via Impersonation of Financial Institution Support](https://www.ic3.gov/PSA/2025/PSA251125)
